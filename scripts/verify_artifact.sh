...
"$python_bin" scripts/verify_artifact.py --manifest research/results/development/objective_study_v1/manifest.json --protocol research/protocols/objective_study_v1.md --portable-summary
"$python_bin" scripts/analyze_objective_study.py --verify-output research/results/development/objective_study_v1/analysis.json
"$python_bin" scripts/audit_objective_gradients.py --verify-output research/results/development/objective_study_v1/gradient_diagnostics.json
...
"$python_bin" scripts/profile_world_efficiency.py --verify-output research/results/development/world_v3_efficiency.json
"$python_bin" scripts/profile_world_efficiency.py --verify-output research/results/development/world_global_coupling_v1_efficiency.json
"$python_bin" scripts/run_nri_external_study.py --verify-capsule research/results/development/nri_external_development_v1.json
