...
def test_backward_step():
    ...
    losses = model.losses(batch, {"rec": 1.0, "equiv": 0.8, "inv": 0.8, "scale": 0.2, "proj": 0.2, "spectral": 0.1, "geom": 0.1, "vq": 1.0, "node": 0.1, "moment": 0.05, "identity": 0.05, "kl": 0.01, "depth": 0.05}, warmup=False)
